...
<head>
    ...
    <!-- Title -->
    <title>Dashboard | Toure Distribution</title>
...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
    ...
    <!-- ========== MAIN CONTENT ========== -->
    <!-- Navbar Vertical -->
    <?php require './views/includes/asside.php'; ?>
    <!-- End Navbar Vertical -->
    <?php echo $content; ?>
    <!-- ========== END MAIN CONTENT ========== -->
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="hs-has-sub-menu nav-item">
                                    ...
                                    <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="dashboardsMegaMenu" style="min-width: 14rem;">
                                        <a class="dropdown-item active" href="index-2.html">Default</a>
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 May 2025 12:07:51 GMT -->
