...
<style>
    ...
    .form-control:focus {
        border-color: var(--primary-color);
        box-shadow: 0 0 0 0.15rem rgba(240, 4, 128, 0.25);
        background-color: #fff;
    }
    ...
    .status-card:hover {
        border-color: var(--primary-color);
        transform: translateY(-1px);
        box-shadow: 0 3px 10px rgba(240, 4, 128, 0.15);
    }

    .status-card.selected {
        border-color: var(--primary-color);
        background: var(--light-primary);
        box-shadow: 0 3px 10px rgba(240, 4, 128, 0.2);
    }
...
<main id="content" role="main" class="main font-public-sans">
    <div class="content container-fluid">
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active">Modifier Chauffeur</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">
                        <i class="bi-pencil-square me-2"></i>Modifier le Chauffeur
                    </h1>
                    <p class="mb-0" id="chauffeurName">Chargement...</p>
                </div>

                <div class="col-sm-auto">
                    <a class="btn btn-outline-light btn-sm" href="/chauffeurs">
        ...
        <div class="loading-spinner" id="loadingSpinner">
            ...
            <p class="mt-3">Chargement des données du chauffeur...</p>
        </div>
        ...
        <div class="error-message d-none" id="errorMessage">
            ...
            <p id="errorText">Une erreur s'est produite lors du chargement des données du chauffeur.</p>
        ...
        <div class="d-none" id="formContainer">
            <div class="form-container">
                ...
                <form id="editChauffeurForm" class="form-body">
                    <div class="info-box">
                        <i class="bi-info-circle"></i>
                        <div class="info-box-content">
                            <div class="info-box-title">Modification des informations</div>
                            <div class="info-box-text">
                                Vous pouvez modifier les informations du chauffeur ci-dessous. Les champs marqués d'un * sont obligatoires.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="status-selection">
                                ...
                                <p class="text-muted small mb-2">Sélectionnez le statut du chauffeur</p>
                ...
                <div class="form-actions">
                    ...
                    <div class="btn-group">
                        ...
                        <button type="submit" class="btn btn-primary-custom" id="saveBtn" form="editChauffeurForm">
...
<script>
    ...
    async function loadChauffeurData() {
        try {
            ...
            currentChauffeurId = pathParts[pathParts.length - 2]; // /chauffeur/{id}/modifier
            ...
            if (data.success && data.data) {
                ...
                populateForm(currentChauffeurData);
                showForm();
            } else {
    ...
    function populateForm(chauffeur) {
        ...
        document.getElementById('date_expiration_permis').value = formatDate(chauffeur.date_expiration_permis);
        
        // Sélectionner le statut
        selectStatus(chauffeur.status || 'actif');
    }
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            if (result.success) {
                ...
                setTimeout(() => {
                    window.location.href = `/chauffeur/${currentChauffeurId}`;
                }, 2000);
            } else {
    ...
    function setupEventListeners() {
        ...
        // Form submission
        document.getElementById('editChauffeurForm').addEventListener('submit', handleSubmit);
    }
